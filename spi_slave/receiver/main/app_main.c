...
void app_main(void)
{
    ...
    WORD_ALIGNED_ATTR uint8_t source_buffer[BUFFER_SIZE];
    WORD_ALIGNED_ATTR uint8_t receive_buffer[BUFFER_SIZE];
    // memset(recvbuf, 0, 33);
    ...
    while( true ) {
        ...
        memcpy(source_buffer, receive_buffer, BUFFER_SIZE);
        memset(receive_buffer, 0x00, sizeof(receive_buffer));
        ...
        */
        ...
        ESP_LOG_BUFFER_HEX("Received", receive_buffer, 15);
